    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          // Dashboard Title and Sort Button
          Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildQuickActionCard(
                    context: context,
                    label: 'Get Lead',
                    iconPath: 'assets/icons/lead.png',
                    onTap: () {
                      Navigator.push(
                        context,
                  ...
                  _buildQuickActionCard(
                    context: context,
                    label: 'Get Enquiry',
                    iconPath: 'assets/icons/get enquiry.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  _buildQuickActionCard(
                    context: context,
                    label: 'Get Referral',
                    iconPath: 'assets/icons/referral.png',
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
